...
void printStatistics() {
  ...
  delay(300);
  Keyboard.println(data.clicks_btn1_in_game);
  Keyboard.println(data.clicks_btn1_in_work);
  Keyboard.println(data.clicks_btn2_in_game);
  Keyboard.println(data.clicks_btn2_in_work);
  Keyboard.println(data.clicks_wheel_down_in_game);
  Keyboard.println(data.clicks_wheel_up_in_game);
  Keyboard.println(data.clicks_wheel_down_in_work);
  Keyboard.println(data.clicks_wheel_up_in_work);
  Keyboard.println(data.clicks_func_btn);
  Keyboard.println(data.clicks_func_btn_unlock_pc);
  Keyboard.println(data.clicks_lock_pc);
  Keyboard.println(data.clicks_sleep_pc);
  Keyboard.println(data.show_statistics_amount);
  Keyboard.println(data.all_work_time);
  Keyboard.println(data.all_game_time);
  Keyboard.println(data.all_sleep_time);
  Keyboard.println(data.all_always_on_mode_time);
  printHome(F("\n"));
  printHome(F("\n"));
  printHome(F(" / ___ \\              | |  / )             (_____ \\          | |\n"));
  printHome(F("| |   | | ____  _   _ | | / /  ____  _   _  _____) )____   _ | |\n"));
  printHome(F("| |   | |/ ___|| | | || |< <  / _  )| | | ||  ____// _  | / || |\n"));
  printHome(F("| |___| |\\___ \\| |_| || | \\ \\( (/ / | |_| || |    ( ( | |( (_| |\n"));
  printHome(F(" \\_____/ |____/ \\____||_|  \\_)\\____) \\__  ||_|     \\_||_| \\____|\n"));
  printHome(F("                                    (____/                      \n"));
  printHome(F("\n"));
  printHome(F("\n"));
  printHome(F("                          Staticstics\n"));
  printHome(F("|-----------------------+------------+------------+------------|\n"));
  printHome(F("|      Value\\Mode       | GAME MODE  | WORK MODE  |    ALL     |\n"));
  printHome(F("|-----------------------+------------+------------+------------|\n"));
  printHome(F("| Button 1, clicks      |            |            |            |\n"));
  printHome(F("|-----------------------+------------+------------+------------|\n"));
  printHome(F("| Button 2, clicks      |            |            |            |\n"));
  printHome(F("|-----------------------+------------+------------+------------|\n"));
  printHome(F("| Func button, clicks   | ========== | ========== |            |\n"));
  printHome(F("|-----------------------+------------+------------+------------|\n"));
  printHome(F("| Wheel, ticks down     |            |            |            |\n"));
  printHome(F("|-----------------------+------------+------------+------------|\n"));
  printHome(F("| Wheel, ticks up       |            |            |            |\n"));
  printHome(F("|-----------------------+------------+------------+------------|\n"));
  printHome(F("\n"));
...
void printHome(const __FlashStringHelper* st) {
  Keyboard.print(st);
